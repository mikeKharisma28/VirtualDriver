...
public class RepositionSceneButtonsScript : MonoBehaviour 
{
    ...
    void Update()
    {
        ...
        {
            if (Player.GetComponent<Rigidbody>().velocity.magnitude * 3.6f >= 20f)
            ...
            else
            {
                ...
                else if (RepositionCheckpoints.isAccomplished)
                {
                    Time.timeScale = 0.5f;
                    onPlayPanel.SetActive(false);
                    onPauseWindow.SetActive(false);
